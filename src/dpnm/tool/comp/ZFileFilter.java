 ...
 * @author Jeff Dinkins
 */
public class ZFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
    ...
    public void ignoreDirectory(boolean flag) {
    	ignoreDirectory = flag;
    }
	...
	if(f != null) {
	    ...
	    if(f.isDirectory() && !ignoreDirectory) {
		return true;
	    }
